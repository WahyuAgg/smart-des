...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\agg\projects\KKN\web_desa\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\agg\\projects\\KKN\\web_desa\\public\\storage','logging.default',
...
'sanctum.csrf-cookie',
'alamat.index','alamat.store','alamat.show','alamat.update','alamat.destroy',
'inv-barang.index','inv-barang.store','inv-barang.show','inv-barang.update','inv-barang.destroy',
'inv-detail-peminjaman.index','inv-detail-peminjaman.store','inv-detail-peminjaman.show','inv-detail-peminjaman.update','inv-detail-peminjaman.destroy',
...
'inv-peminjaman.index','inv-peminjaman.store','inv-peminjaman.show','inv-peminjaman.update','inv-peminjaman.destroy',
...
'ref-profil-desa.index','ref-profil-desa.store','ref-profil-desa.show','ref-profil-desa.update','ref-profil-desa.destroy',
...
'srt-jenis-surat.index','srt-jenis-surat.store','srt-jenis-surat.show','srt-jenis-surat.update','srt-jenis-surat.destroy',
'srt-kategori-surat.index','srt-kategori-surat.store','srt-kategori-surat.show','srt-kategori-surat.update','srt-kategori-surat.destroy',
'srt-master-field-surat.index','srt-master-field-surat.store','srt-master-field-surat.show','srt-master-field-surat.update','srt-master-field-surat.destroy',
'srt-pengajuan-surat.index','srt-pengajuan-surat.store','srt-pengajuan-surat.show','srt-pengajuan-surat.update','srt-pengajuan-surat.destroy',
'users.index','users.store','users.show','users.update','users.destroy',
'dashboard','surat.index','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'components.alert','components.step-indicator','layouts.app','partials.footer','partials.head',
'partials.navbar','partials.sidebar','surat.index','surat.steps.isi-data-manual','surat.steps.isi-nik',
'surat.steps.pilih-jenis-surat','surat.steps.preview-download','indonesia::kabupaten.create','indonesia::kabupaten.edit','indonesia::kabupaten.index',
'indonesia::kecamatan.create','indonesia::kecamatan.edit','indonesia::kecamatan.index','indonesia::kelurahan.create','indonesia::kelurahan.edit',
'indonesia::kelurahan.index','indonesia::provinsi.create','indonesia::provinsi.edit','indonesia::provinsi.index','laravel-exceptions-renderer::components.badge',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SURAT_API_URL',);
