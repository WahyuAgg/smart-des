    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'zipstream.builder' => \STS\ZipStream\Builder::class,
        ]));
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/curk7128/public_html/storage' => 'string',
            ...
            'services.libreoffice.path' => 'string',
            ...
            'zipstream.predict_size' => 'boolean',
            'zipstream.compression_method' => 'string',
            'zipstream.ascii_filenames' => 'boolean',
            'zipstream.conflict_strategy' => 'string',
            'zipstream.case_insensitive_conflicts' => 'boolean',
            'zipstream.aws.credentials.key' => 'NULL',
            'zipstream.aws.credentials.secret' => 'NULL',
            'zipstream.aws.version' => 'string',
            'zipstream.aws.endpoint' => 'NULL',
            'zipstream.aws.use_path_style_endpoint' => 'boolean',
            'zipstream.aws.region' => 'string',
            'zipstream.aws_anonymous_client' => 'boolean',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/curk7128/public_html/storage','logging.default',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.libreoffice.path','session.driver',
...
'excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','zipstream.predict_size','zipstream.compression_method','zipstream.ascii_filenames',
'zipstream.conflict_strategy','zipstream.case_insensitive_conflicts','zipstream.aws.credentials.key','zipstream.aws.credentials.secret','zipstream.aws.version',
'zipstream.aws.endpoint','zipstream.aws.use_path_style_endpoint','zipstream.aws.region','zipstream.aws_anonymous_client','ide-helper.filename',
...
'sanctum.csrf-cookie',
'penduduk.index','penduduk.store','penduduk.show','penduduk.update','penduduk.destroy',
'kk.index','kk.store','kk.show','kk.update','kk.destroy',
'pekerjaan.index','pekerjaan.store','pekerjaan.show','pekerjaan.update','pekerjaan.destroy',
'pendidikan.index','pendidikan.store','pendidikan.show','pendidikan.update','pendidikan.destroy',
'ref-dusun.index','ref-dusun.store','ref-dusun.show','ref-dusun.update','ref-dusun.destroy',
'ref-jabatan-perangkat.index','ref-jabatan-perangkat.store','ref-jabatan-perangkat.show','ref-jabatan-perangkat.update','ref-jabatan-perangkat.destroy',
'ref-perangkat-desa.index','ref-perangkat-desa.store','ref-perangkat-desa.show','ref-perangkat-desa.update','ref-perangkat-desa.destroy',
'ref-rt.index','ref-rt.store','ref-rt.show','ref-rt.update','ref-rt.destroy',
'ref-rw.index','ref-rw.store','ref-rw.show','ref-rw.update','ref-rw.destroy',
'inv-kategori-barang.index','inv-kategori-barang.store','inv-kategori-barang.show','inv-kategori-barang.update','inv-kategori-barang.destroy',
'inv-lokasi.index','inv-lokasi.store','inv-lokasi.show','inv-lokasi.update','inv-lokasi.destroy',
'inv-barang.index','inv-barang.store','inv-barang.show','inv-barang.update','inv-barang.destroy','inv-detail-peminjaman.index','inv-detail-peminjaman.store','inv-detail-peminjaman.show',
'inv-detail-peminjaman.update','inv-detail-peminjaman.destroy','inv-peminjaman.index','inv-peminjaman.store','inv-peminjaman.show',
'inv-peminjaman.update','inv-peminjaman.destroy','inv-mutasi.index',
'inv-mutasi.store','inv-mutasi.show','inv-mutasi.destroy','inv-detail-mutasi.index','inv-detail-mutasi.show',
'users.index','users.store','users.show','users.update','users.destroy','srt-jenis-surat.index',
'srt-jenis-surat.store','srt-jenis-surat.show','srt-jenis-surat.update','srt-jenis-surat.destroy','srt-kategori-surat.index',
'srt-kategori-surat.store','srt-kategori-surat.show','srt-kategori-surat.update','srt-kategori-surat.destroy','srt-master-field-surat.index',
'srt-master-field-surat.store','srt-master-field-surat.show','srt-master-field-surat.update','srt-master-field-surat.destroy','login','about','peta-desa',
'galeri','bacaan.index','bacaan.show','surat.index','surat.riwayat',
'dashboard','master-data.master-field-surat.index','master-data.kk.index','master-data.pendidikan.index','master-data.jabatan-perangkat.index',
'master-data.perangkat-desa.index','master-data.penduduk.index','master-data.kategori-surat.index','master-data.jenis-surat.index','master-data.dusun.index',
'master-data.rw.index','master-data.rt.index','master-data.profil-desa.index','inventaris.kategori-barang.index','inventaris.lokasi.index',
'inventaris.barang.index','inventaris.barang.detail','inventaris.peminjaman.index','inventaris.peminjaman.detail','inventaris.mutasi.index',
'inventaris.mutasi.show','manajemen-konten.artikel.index','manajemen-konten.galeri.index','admin-sistem.user.index','admin-sistem.backup.index',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'about.index','admin-sistem.backup.index','admin-sistem.user.index','admin-sistem.user.partials.form','auth.login',
'bacaan.index','bacaan.show','components.alert','components.confirm-dialog','components.form.input',
'components.form.select','components.form.textarea','components.master-data-toolbar','components.modal','components.pagination',
'components.step-indicator','dashboard.index','dashboard.partials.chart-agama','dashboard.partials.chart-gender','dashboard.partials.chart-pekerjaan',
'dashboard.partials.chart-pendidikan','dashboard.partials.chart-umur','dashboard.partials.perangkat-desa','dashboard.partials.profile-header','dashboard.partials.riwayat-surat',
'dashboard.partials.stat-cards','dashboard.partials.visi-misi','galeri.index','inventaris.barang.detail','inventaris.barang.index',
'inventaris.barang.partials.form','inventaris.barang.partials.modal-hapus-stok','inventaris.barang.partials.modal-hilang','inventaris.barang.partials.modal-ketemu','inventaris.barang.partials.modal-opname',
'inventaris.barang.partials.modal-pengadaan','inventaris.barang.partials.table','inventaris.kategori-barang.index','inventaris.kategori-barang.partials.form','inventaris.kategori-barang.partials.table',
'inventaris.lokasi.index','inventaris.lokasi.partials.form','inventaris.lokasi.partials.table','inventaris.mutasi.index','inventaris.mutasi.partials.filter',
'inventaris.mutasi.partials.table','inventaris.mutasi.show','inventaris.peminjaman.detail','inventaris.peminjaman.index','inventaris.peminjaman.partials.form',
'inventaris.peminjaman.partials.table','layouts.app','layouts.auth','manajemen-konten.artikel.index','manajemen-konten.artikel.partials.form',
'manajemen-konten.galeri.index','manajemen-konten.galeri.partials.form','master-data.dusun.index','master-data.dusun.partials.form','master-data.dusun.partials.table',
'master-data.jabatan-perangkat.index','master-data.jabatan-perangkat.partials.form','master-data.jabatan-perangkat.partials.table','master-data.jenis-surat.index','master-data.jenis-surat.partials.form',
'master-data.jenis-surat.partials.table','master-data.kategori-surat.index','master-data.kategori-surat.partials.form','master-data.kategori-surat.partials.table','master-data.kk.index',
'master-data.kk.partials.form','master-data.kk.partials.table','master-data.master-field-surat.index','master-data.master-field-surat.partials.form','master-data.master-field-surat.partials.table',
'master-data.pendidikan.index','master-data.pendidikan.partials.form','master-data.pendidikan.partials.table','master-data.penduduk.index','master-data.penduduk.partials.detail',
'master-data.penduduk.partials.form-alamat','master-data.penduduk.partials.form-identitas','master-data.penduduk.partials.form-keluarga','master-data.penduduk.partials.form-kontak','master-data.penduduk.partials.form-lookup',
'master-data.penduduk.partials.table','master-data.perangkat-desa.index','master-data.perangkat-desa.partials.form','master-data.perangkat-desa.partials.table','master-data.profil-desa.index',
'master-data.profil-desa.partials.form','master-data.profil-desa.partials.show','master-data.rt.index','master-data.rt.partials.form','master-data.rt.partials.table',
'master-data.rw.index','master-data.rw.partials.form','master-data.rw.partials.table','partials.footer','partials.head',
'partials.navbar','partials.sidebar','peta-desa.index','surat.index','surat.riwayat.index',
'surat.steps.isi-data-manual','surat.steps.isi-nik','surat.steps.pilih-jenis-surat','surat.steps.preview-download','indonesia::kabupaten.create',
'indonesia::kabupaten.edit','indonesia::kabupaten.index','indonesia::kecamatan.create','indonesia::kecamatan.edit','indonesia::kecamatan.index',
'indonesia::kelurahan.create','indonesia::kelurahan.edit','indonesia::kelurahan.index','indonesia::provinsi.create','indonesia::provinsi.edit',
'indonesia::provinsi.index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.agg.projects.KKN.web_desa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_DATABASE','DB_FOREIGN_KEYS','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
'SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION',
'CACHE_STORE','VITE_APP_NAME','VITE_API_BASE_URL','FILESYSTEM_DISK','LIBREOFFICE_PATH',
'PUBLIC_PATH',);
