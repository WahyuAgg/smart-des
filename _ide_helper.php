...
namespace STS\ZipStream\Facades {
    ...
    class Zip {
         ...
         * @static
         */
        public static function extend($fileClass)
        {
            /** @var \STS\ZipStream\Builder $instance */
            return $instance->extend($fileClass);
        }

        /**
         * @static
         */
        public static function addDirectory($name)
        {
            /** @var \STS\ZipStream\Builder $instance */
            return $instance->addDirectory($name);
        }
...
namespace STS\ZipStream {
    /**
     */
    class Queue extends \Illuminate\Support\Collection {
            }
    }
