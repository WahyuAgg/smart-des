...
<div x-data="loginForm" class="w-full max-w-md">
  ...
  <div class="text-center mb-8">
    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-accent/20 backdrop-blur-sm border border-accent/30 mb-4">
      <div class="w-10 h-10 rounded-lg bg-accent flex items-center justify-center font-bold text-white text-xl">S</div>
    </div>
    ...
    <form @submit.prevent="submit()" class="space-y-5">
        ...
        <div class="relative">
          <div class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.9 5.2a2 2 0 0 0 2.2 0L21 8M5 19h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2Z" />
            </svg>
          </div>
      ...
      <div>
        ...
        <div class="relative">
          <div class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
              <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-2.25 0h13.5a1.5 1.5 0 0 1 1.5 1.5v6.75a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V12a1.5 1.5 0 0 1 1.5-1.5Z" />
            </svg>
          </div>
  ...
  {{-- Footer --}}
  <p class="text-center text-xs text-slate-500 mt-6">&copy; {{ date('Y') }} SIAK Desa &mdash; Sistem Informasi Administrasi Kependudukan</p>
</div>
@endsection
