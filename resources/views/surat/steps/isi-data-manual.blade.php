<div x-show="step === 3" x-cloak>
    ...
    <div class="space-y-4">
      <template x-for="field in autoFields" :key="field.placeholder">
        <div>
          ...
          <input :type="field.type === 'number' ? 'number' : 'text'" x-model="dataSurat[field.placeholder]"
  ...
  <div class="flex justify-between mt-6">
    <button type="button" @click="kembali()" class="px-4 py-2 text-sm font-medium text-slate-600 hover:text-slate-800">
      &larr; Kembali
    </button>
