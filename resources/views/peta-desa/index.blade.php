...
<div x-data="petaDesa" class="max-w-7xl mx-auto space-y-5">
  ...
  <div x-show="!loading && error" x-cloak
    ...
    <button @click="loadPeta()" class="mt-4 px-4 py-2 rounded-lg text-sm font-medium text-white bg-accent hover:bg-accent-hover">
      Coba Lagi
    </button>
  </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div class="flex items-center justify-between px-4 py-3 bg-slate-50 border-b border-slate-200">
        <div class="flex items-center gap-2">
          ...
          <span class="text-sm font-medium text-slate-600 w-14 text-center" x-text="Math.round(zoom * 100) + '%'"></span>
