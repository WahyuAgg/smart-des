...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 p-5 hover:shadow-md transition-shadow">
  <div class="flex items-center justify-between mb-4">
    <div class="flex items-center gap-2">
      <div class="w-8 h-8 rounded-lg bg-linear-to-br from-sky-400 to-sky-600 flex items-center justify-center shadow-sm">
  ...
  <template x-if="riwayatSurat.length === 0">
    <p class="text-sm text-slate-400 text-center py-6">Belum ada riwayat surat</p>
  </template>
</div>