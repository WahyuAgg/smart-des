<div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
  <div>
    ...
    <h1 class="text-2xl font-semibold text-slate-900 mt-1">Pendidikan</h1>
    <p class="text-sm text-slate-500 mt-1">Tambah, ubah, cari, dan hapus data tingkat pendidikan.</p>
  </div>
